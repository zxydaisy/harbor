...
func initRouters() {
	...
	beego.Router("/api/customer/list", &api.CustomerController{}, "post:GetListCustomer")
	...
	beego.Router("/api/customer/?:id", &api.CustomerController{}, "put:UpdateCustomer")
	beego.Router("/api/customer/?:id", &api.CustomerController{}, "delete:DeleteCustomer")

	//根据项目ID修改项目中文名称
	beego.Router("/api/project_desc/?:id", &api.ProjectDescController{}, "put:UpdateProject")
